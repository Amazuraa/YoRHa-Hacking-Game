...
var deg = 0.0
export var rotating_speed = 100.0

var rotating_speed_backup = rotating_speed
...
func _ready():
	timer = delay
	add_to_group("enemy")
	bullet1_tscn = preload("res://scenes/enemy_bullet_type2.tscn")
	bullet2_tscn = preload("res://scenes/enemy_bullet_type3.tscn")
	set_process(true)
	pass
...
func method():
	if deg > 355.0:
		if rotation_count == 15:
			bullet1_tscn = preload("res://scenes/enemy_bullet_type1.tscn")
			bullet2_tscn = preload("res://scenes/enemy_bullet_type2.tscn")
			ult_state = 0
			ult_state += 1
